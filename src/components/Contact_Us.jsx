...
const Contact = () => {
  ...
  const iconBoxBg = theme
    ? 'bg-white border-slate-200/60 shadow-sm text-slate-700'
        ...
        <div className="md:col-span-2 flex flex-col gap-3">
          ...
          >
            <div className="flex items-center gap-4">
              <div
                className={`w-10 h-10 flex items-center justify-center rounded-lg border group-hover:text-emerald-500 group-hover:border-emerald-500/20 transition-colors duration-300 ${iconBoxBg}`}
              >
              ...
              <div className="flex flex-col">
                <span className={`t-caption font-bold tracking-wider uppercase opacity-60 ${subTextColor}`}>{copied ? 'Success' : 'Email'}</span>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <span className={`t-caption font-bold tracking-wider uppercase opacity-60 ${subTextColor}`}>{link.label}</span>
                    <span className={`t-small font-medium transition-colors duration-200 ${textColor} group-hover:text-emerald-500`}>{link.value}</span>
                  </div>
                </div>
