...
const tabs = [
  ...
  },
  {
    ...
    lines: [
      ...
      { type: 'indent', level: 1, keys: '', value: 'GSAP · Three.js · Framer Motion', valueClass: 'str' },
      { type: 'indent', level: 1, keys: '', value: 'TanStack Query · Zustand · Prisma', valueClass: 'str' },
      { type: 'indent', level: 1, keys: '', value: 'shadcn/ui · HTML5 · CSS3', valueClass: 'str' },
      { type: 'punct', text: '];' },
    ],
  },
  {
