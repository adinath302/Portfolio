...
const tabs = [
  {
    ...
    lines: [
      ...
      { type: 'indent', level: 1, keys: 'stack', value: "['React', 'Next.js', 'TS', 'Tailwind']", valueClass: 'arr' },
      { type: 'indent', level: 1, keys: 'experience', value: '3+ years', valueClass: 'str' },      { type: 'indent', level: 1, keys: 'location', value: 'India', valueClass: 'str' },
  ...
  },
  {
    ...
    lines: [
      ...
      { type: 'indent', level: 1, keys: '', value: 'JavaScript · Tailwind CSS · Vite', valueClass: 'str' },
      { type: 'indent', level: 1, keys: '', value: 'GSAP · TanStack Query · Zustand', valueClass: 'str' },
      { type: 'indent', level: 1, keys: '', value: 'Framer Motion · Prisma · shadcn/ui', valueClass: 'str' },
      { type: 'indent', level: 1, keys: '', value: 'HTML5 · CSS3', valueClass: 'str' },
      { type: 'punct', text: '];' },
    ],
  },
  {
